...
- [x] Cloud browser coverage proves PIN access, separate editor and Client contexts, comment creation, resolution, reopening, portal closure, closed-link refusal, and preserved internal history.

Verified in a configured Clerk and Convex environment with `npx playwright test e2e/cloud-workflow.spec.ts --reporter=line` on August 27, 2026.
