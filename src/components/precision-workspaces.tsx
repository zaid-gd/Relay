                        ...
                        <motion.button
                          ...
                          className={cn(
                            ...
                            selected?.id === project.id &&
                              "bg-[var(--app-active)] shadow-[inset_2px_0_var(--app-highlight)]"
                          )}
        ...
        >
          <div className="overflow-x-auto border-t border-[var(--app-border)]">
            <table className="w-full min-w-[760px] border-collapse">
              <thead>
                <tr className="bg-[var(--app-soft-panel)] text-left text-[10px] font-semibold uppercase text-[var(--app-subtle)]">
                  <th className="h-8 px-4">Draft</th>
              ...
              <tbody className="divide-y divide-[var(--app-border)]">
                {invoiceDrafts.map((draft) => (
                  ...
                  >
                    ...
                    <td className="px-4 text-[var(--app-muted)]">
                      {draft.client}
                    </td>
        ...
        >
          <div className="overflow-x-auto border-t border-[var(--app-border)]">
            <table className="w-full min-w-[720px] border-collapse">
              <thead>
                <tr className="bg-[var(--app-soft-panel)] text-left text-[10px] font-semibold uppercase text-[var(--app-subtle)]">
                  <th className="h-8 px-4">Batch</th>
                  <th className="px-4">Completed</th>
                  <th className="px-4">Edits</th>
