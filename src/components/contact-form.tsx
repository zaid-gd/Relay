...
const fieldClass = "min-h-12 w-full rounded-md border border-[var(--app-strong-border)] bg-[var(--app-control)] px-3 py-2 text-base text-[var(--app-ink)] outline-none transition-colors placeholder:text-[var(--app-subtle)] focus:border-[var(--app-accent)] focus:ring-2 focus:ring-[color-mix(in_srgb,var(--app-accent)_24%,transparent)]";
