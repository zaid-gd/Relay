...
export interface MagicBentoSurfaceProps extends BentoProps {
...
export function MagicBentoSurface({
  children,
  className = "",
  enableStars = false,
  ...
  return (
    <>
      ...
      <div
        className={`bento-section magic-bento-surface ${className}`}
        ref={gridRef}
      >
        {React.Children.map(children, (child) => (
          <ParticleCard
            className="card magic-bento-card"
            disableAnimations={shouldDisableAnimations}
